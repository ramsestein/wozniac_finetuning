...
def main():
    ...
    print(f"Converting {INPUT_FILE} to BIO format (ANON-B/ANON-I) using tokenizer...")
        ...
        for line_num, line in enumerate(fin, 1):
            ...
            try:
                ...
                for entity in sorted_entities:
                    ...
                    # We map DIAGNOSIS (or any entity in this dataset) to ANON labels
                    ...
                    while True:
                        ...
                        if is_free:
                            # Use ANON-B and ANON-I as native labels
                            char_labels[start_idx] = "ANON-B"
                            for i in range(start_idx + 1, end_idx):
                                char_labels[i] = "ANON-I"
